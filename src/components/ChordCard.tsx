...
export default function ChordCard({ 
  ...
  return (
    ...
    >
      ...
      {/* Chord index */}
      <div className="absolute top-3 left-3 text-xs font-semibold text-gray-500 bg-gray-700/50 rounded-full w-6 h-6 flex items-center justify-center transition-all duration-200 group-hover:scale-110">
        {index + 1}
      </div>
      ...
      <div className="relative z-10 text-center flex flex-col justify-center h-full">
        <div className="text-3xl font-bold text-gray-200 mb-2 group-hover:text-amber-400 transition-all duration-200 group-hover:scale-105">
          {getChordSymbol()}
        </div>
        <div className="text-xs text-gray-400 font-medium uppercase tracking-wider mb-2 transition-all duration-200">
        ...
        <div className="text-xs text-gray-500 font-mono opacity-0 group-hover:opacity-100 transition-all duration-200 group-hover:translate-y-1">
          {getChordNotes()}
        </div>
      </div>
